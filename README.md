...
local LOGO_ID = "rbxassetid://826468633725"
...
if CoreGui:FindFirstChild("bloodLagger_UI") then
    CoreGui.bloodLagger_UI:Destroy()
end

local screenGui = Instance.new("ScreenGui")
screenGui.Name = "bloodLagger_UI"
...
backgroundLogo.Image = LOGO_ID
backgroundLogo.ImageTransparency = 0.15
...
glowStroke.Color = Color3.fromRGB(100, 100, 100)
...
glowGrad.Color = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(0.4, Color3.fromRGB(80, 80, 80)),
    ColorSequenceKeypoint.new(0.6, Color3.fromRGB(80, 80, 80)),
...
subTitle.Text = "https://discord.gg/wUesFwMMZ"
